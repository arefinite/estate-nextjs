...
const AmenitiesPage = () => {
  return (
    <section>
      <SitePath items={false} currentPage='Amenities' />

      <div className='mt-6 flex justify-between items-center'>
        <h1 className='text-lg font-semibold md:text-2xl'>Amenities List</h1>
        <div>
          
          <Link href='/admin/dashboard/amenities/add-amenity'>
